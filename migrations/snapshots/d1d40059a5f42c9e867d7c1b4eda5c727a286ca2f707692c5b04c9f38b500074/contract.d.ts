...
export type FieldOutputTypes = {
  readonly public: {
    readonly AuthIdentity: {
      ...
      readonly providerSubject: CodecTypes['pg/text@1']['output'] | null;
    ...
    readonly PasswordCredential: {
      ...
      readonly authIdentityId: CodecTypes['pg/uuid@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly User: {
...
export type FieldInputTypes = {
  readonly public: {
    readonly AuthIdentity: {
      ...
      readonly provider: 'PASSWORD' | 'GOOGLE' | 'GITHUB';
      readonly providerSubject: CodecTypes['pg/text@1']['input'] | null;
    ...
    readonly PasswordCredential: {
      ...
      readonly authIdentityId: CodecTypes['pg/uuid@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
    readonly User: {
...
export type StorageColumnTypes = {
  readonly public: {
    readonly auth_identities: {
      ...
      readonly id: CodecTypes['pg/uuid@1']['output'];
      readonly provider: 'PASSWORD' | 'GOOGLE' | 'GITHUB';
      readonly provider_subject: CodecTypes['pg/text@1']['output'] | null;
...
export type StorageColumnInputTypes = {
  readonly public: {
    ...
    readonly password_credential: {
      readonly auth_identity_id: CodecTypes['pg/uuid@1']['input'];
      readonly created_at: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly id: CodecTypes['pg/uuid@1']['input'];
...
export namespace Models {
  ...
  export type public_AuthIdentity = {
    ...
    providerSubject: CodecTypes['pg/text@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    passwordCredential: public_PasswordCredential | null;
    user: public_User;
    readonly [RelationKeys]?: 'passwordCredential' | 'user';
  };
  export type public_PasswordCredential = {
    id: CodecTypes['pg/uuid@1']['output'];
    passwordHash: CodecTypes['pg/text@1']['output'];
    authIdentityId: CodecTypes['pg/uuid@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
          ...
          readonly table: {
            readonly auth_identities: {
              ...
              uniques: readonly [
                ...
                { readonly columns: readonly ['provider', 'provider_subject'] },
              ];
              indexes: readonly [
                {
            ...
            readonly password_credential: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['auth_identity_id'] }];
              indexes: readonly [];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'password_credential';
                    readonly columns: readonly ['auth_identity_id'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'auth_identities';
          ...
          readonly AuthIdentity: {
            ...
            readonly relations: {
              readonly passwordCredential: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['authIdentityId'];
                };
              };
              readonly user: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly providerSubject: { readonly column: 'provider_subject' };
          ...
          readonly PasswordCredential: {
            ...
            readonly relations: {
              readonly authIdentity: {
                ...
                readonly nullable: false;
                readonly on: {
                  readonly localFields: readonly ['authIdentityId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly authIdentityId: { readonly column: 'auth_identity_id' };
                readonly createdAt: { readonly column: 'created_at' };
                readonly updatedAt: { readonly column: 'updated_at' };
              };
            };
